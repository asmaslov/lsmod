...
#define RX_BUFFER_SIZE  (LSMOD_DATA_SRV_LEN + LSMOD_DATA_IDX_LEN + LSMOD_DATA_MAX_LEN)
#define TX_BUFFER_SIZE  (LSMOD_DATA_SRV_LEN + LSMOD_DATA_IDX_LEN + LSMOD_DATA_MAX_LEN)
